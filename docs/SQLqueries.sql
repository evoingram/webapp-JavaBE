...
SELECT FinalUnitPriceInvoiceQuery.CourtDatesID AS CourtDatesID, (QTotalPricebyInvoiceNumber.[TotalPrice]-[QTotalPaymentsbyInvoiceNumber].[TotalPayments]) AS BalanceOwed, FinalUnitPriceInvoiceQuery.*, QTotalPaymentsbyInvoiceNumber.TotalPayments, QTotalCreditApprovedCostbyInvoiceNumber.TotalCreditApprovedCost, QTotalPricebyLastFirstName.TotalPrice
FROM ((FinalUnitPriceInvoiceQuery LEFT JOIN QTotalPricebyInvoiceNumber ON FinalUnitPriceInvoiceQuery.InvoiceNo = QTotalPricebyInvoiceNumber.InvoiceNo) LEFT JOIN QTotalPaymentsbyInvoiceNumber ON FinalUnitPriceInvoiceQuery.InvoiceNo = QTotalPaymentsbyInvoiceNumber.InvoiceNo) LEFT JOIN QTotalCreditApprovedCostbyInvoiceNumber ON FinalUnitPriceInvoiceQuery.InvoiceNo = QTotalCreditApprovedCostbyInvoiceNumber.InvoiceNo
...
SELECT [FinalUnitPriceQuery].InvoiceNo, CDbl(Nz(Sum([FinalUnitPriceQuery].[CreditApprovedCost]),0)) AS TotalCreditApprovedCost
FROM FinalUnitPriceQuery
